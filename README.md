...
- In order to install the Mod Manager drop the "DoW Mod Manager v2.0.1.exe" into your primary game directory which is either:
...
1. Once everything is in place launch the "DoW Mod Manager v2.0.1.exe" by double-clicking on it (You may want to create a shortcut of the Mod Manager on your Desktop for convenience and faster access)
