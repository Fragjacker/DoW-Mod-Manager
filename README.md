...
- In order to install the Mod Manager drop the "Dow Mod Manager Resources" folder and the "DoW Mod Manager v1.52.exe" into your primary game directory which is either:
...
1. Once everything is in place launch the "DoW Mod Manager v1.52.exe" by double-clicking on it (You may want to create a shortcut of the Mod Manager on your Desktop
