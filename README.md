...
a) First value is a major version.
b) Second value is a feature version
c) Third value is a bugfix version
So 1.6.0 means "major version 1, feature version 6, bugfix version 0"
Second change is that changelog itself will be presented in more informative way:
a) Added features would be shown with a symbol "+"
b) Deleted features would be shown with a symbol "-"
c) Changed or fixed features would be shown with a symbol "*"
