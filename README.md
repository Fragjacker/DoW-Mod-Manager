![dow_modmanager_v 2 1 4](https://user-images.githubusercontent.com/19975052/104597795-126a0600-5676-11eb-9eed-e7910349d031.png)

# DoW Mod Manager v2.1.4
...
- In order to install the Mod Manager drop the "DoW Mod Manager v2.1.4.exe" into your primary game directory which is either:
...
1. Once everything is in place launch the "DoW Mod Manager v2.1.4.exe" by double-clicking on it (You may want to create a shortcut of the Mod Manager on your Desktop for convenience and faster access)
